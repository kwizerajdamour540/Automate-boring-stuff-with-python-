...
for quiz_num in range(35):
    ...
    with open(f'capitalsquiz{quiz_num + 1}.txt', 'w', encoding='UTF-8') as quiz_file, \
    open(f'capitalsquiz_answers{quiz_num + 1}.txt', 'w', encoding='UTF-8') as answer_file:
        ...
        # TODO: Loop through all 50 states, making a question for each. for num in range(50):
